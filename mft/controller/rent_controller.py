...
def find_by_sender_code(sender_code):
    pass
...
class RentController:
    def save(self, code, sender, renter, stuff, rent_date, return_date, stuff_status, rent_price, information):
        try:
            rent = Rent(code, sender, renter, stuff, rent_date, return_date, stuff_status, rent_price, information)
            da = Rent(rent)
            da.save(rent)
            return True, rent
